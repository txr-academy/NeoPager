...
// =================================================================
#define DEVICE_ID 1 //Change the device ID for other pager 
...
#define OLED_RST 21
#define VEXT_CTRL 36
#define BUZZER_PIN 45   // buzzer wire goes here- Pin No. 45

// =================================================================
// RADIO (LoRa) SETTINGS
// Both pagers must use the SAME settings here or they won't talk.
// =================================================================
#define LORA_FREQ 915.0 // frequency allowed for LoRa use in India
...
void showStatus(const char *l1, const char *l2 = "", const char *l3 = "",
  ...
  String hdr = "Pager " + String(DEVICE_ID) + "  915MHz";
...
void showTemplateScreen() {
  ...
  u8g2.clearBuffer();
  u8g2.setFont(u8g2_font_6x10_tf);
  u8g2.drawStr(0, 9, ("Pager " + String(DEVICE_ID) + "  915MHz").c_str());
  u8g2.drawHLine(0, 11, 128);
  u8g2.setFont(u8g2_font_7x13_tf);
